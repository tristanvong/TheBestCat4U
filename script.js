...
// Vraag 2: Hoe moet de haarlengte zijn?
    ...
    if(counter == 3){
        ...
        afbeeldingVeranderen.setAttribute('src', "placeholder.png");
...
overMijKnop.addEventListener('click', function(){
    ...
    profielFoto.setAttribute("src", "profielFotoLinkedIn.jpg");
    ...
    fotoStreepje.setAttribute("src", "FotoStreepje.jpg");
